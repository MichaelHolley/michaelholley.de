<section id="dev" class="dev-bg p-8 md:p-32 lg:p-16">
	<div class="flex flex-row justify-between">
		<div class="lg:w-1/3 sm:px-7 my-8 lg:my-0">
			<h2 class="text-4xl font-bold mb-1 text-start lg:text-end">Backend</h2>
	...
	<div class="flex flex-row justify-center">
		<div class="lg:w-1/3 sm:px-7 my-8 lg:my-0">
			<h2 class="text-4xl font-bold mb-1 text-start lg:text-end">Frontend</h2>
			<p class="text-justify">
	...
	<div class="flex flex-row justify-end">
		<div class="lg:w-1/3 sm:px-7 my-8 lg:my-0">
			<h2 class="text-4xl font-bold mb-1 text-start lg:text-end">DevOps</h2>
			<p class="text-justify">
